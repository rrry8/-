...
{
	//ステージ描画
	origShader_->Draw(lpModelMng.GetID("resource/model/stage/Stage1.mv1")[0],-1);
	...
	origShader_->Draw(lpModelMng.GetID("resource/model/player/player_robot_new.mv1")[0], -1);
}
...
////アイテムリストへ追加
//template<typename T>
//void Stage::AddItemList(std::vector<MarkerObj>& iList, std::wstring objName)
//{
//	std::wstring wstr;
//	for (auto& item : iList)
//	{
