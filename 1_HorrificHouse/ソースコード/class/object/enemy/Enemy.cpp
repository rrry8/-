...
//プレイヤー探索用定数
constexpr float SEARCH_ANGLE	= 20.0f * (DX_PI_F / 180.0f);	//索敵角度
...
void Enemy::Draw(void)
{
	...
	DrawTriangle3D(ePos, leftEndPos, centerEndPos, 0x888800,true);	//左
	DrawTriangle3D(ePos, centerEndPos, rightEndPos, 0x888800, true);	//右
