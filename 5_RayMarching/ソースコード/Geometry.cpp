...
void
Rect::Draw() {
	DxLib::DrawBox(static_cast<int>(Left()) * 2, static_cast<int>(Top()) * 2, static_cast<int>(Right()) * 2, static_cast<int>(Bottom()) * 2, 0xffffffff, false);
}

void
Rect::Draw(Vector2& offset) {
	DxLib::DrawBox(static_cast<int>(Left() + offset.x) * 2, static_cast<int>(Top() + offset.y) * 2, static_cast<int>(Right() + offset.x) * 2, static_cast<int>(Bottom() + offset.y) * 2, 0xffffffff, false);
}
